...
ActiveRecord::Schema.define(version: 2019_06_18_135635) do
  ...
  create_table "order_billing_addresses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["address_id"], name: "index_order_billing_addresses_on_address_id"
    t.index ["order_id"], name: "index_order_billing_addresses_on_order_id"
  end
